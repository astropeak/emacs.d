;; the error will be raised when content contain GBK character. Remove it
(require 'url-http)
    ...
    (setq request
          (concat
           ...
           "Connection: " (if (or using-proxy
                              ...
                              url-http-data))
    ;; Bug#23750
    (message "XXXXX %s, %s" (string-bytes request) (length request))
